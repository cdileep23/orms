...
Run it with:  python manage.py create_data

The model classes are named RestaurantModel / RatingModel / SaleModel,
so they are imported here with shorter aliases.
"""
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        restaurants = [
            ...
            {'name': 'Taco Bell', 'date_opened': timezone.now() - timezone.timedelta(days=12), 'restaurant_type': Restaurant.TypeChoices.OTHER, 'latitude': 53.413959, 'longitude':  -2.254644},
